...
const icons: Record<string, ReactElement> = {
  ...
  heatmap: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="2" y="2" width="3" height="12" rx="1" fill="#10b981"/><rect x="6.5" y="4" width="3" height="10" rx="1" fill="#f59e0b"/><rect x="11" y="6" width="3" height="8" rx="1" fill="#ef4444"/></svg>,
